                            ...
                            <tr key={guest.id}>
                                ...
                                <td>
                                    <div className="flex flex-row items-center gap-2">
                                        <Image src={guest.image || userIcon} alt="user" width={24} height={24} className="rounded-full" />
                                        <p className="whitespace-nowrap">{guest.user.first_name} {guest.user.last_name}</p>
                                    </div>
                                </td>
