    ...
    <main>
      ...
      >
        <div className="text-center text-white">
          ...
          <a href="#features"
            className="btn btn-primary btn-lg rounded-sm md:text-xl hover:scale-105 transition duration-300 ease-in-out">Explore Features</a>
        </div>
      </section>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-white">
          {/* Feature 1 */}
          <div className="rounded-sm p-6 md:p-8 bg-zinc-500">
      ...
      <section className="bg-gray-900 text-white py-16 md:py-20"
        style={{ backgroundImage: "url('/static/image/homepage/bg-5.jpg')" }}
      >
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Contact Us</h2>
          <p className="mb-8">Ready to streamline your hotel management? Reach out to us for more information.</p>
          <Link href="contact"
            className="btn btn-primary btn-lg rounded-sm md:text-xl hover:scale-105 transition duration-300 ease-in-out">
            Contact Now
          </Link>
        </div>
      </section>
