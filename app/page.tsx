  ...
  return (
    <main>
      ...
      <section
        ...
        style={{ backgroundImage: "url('/static/image/homepage/bg-1.jpg')" }}
      >
        ...
        <div className="flex justify-center items-center flex-grow">
          <div className="text-white text-center lg:text-left lg:ms-20">
            ...
            <a href="#features"
              className="btn bg-gradient-to-r from-rose-100 to-teal-100 btn-lg rounded-sm md:text-xl hover:scale-105 transition duration-300 ease-in-out text-gray-900">Explore Features</a>
          </div>
        </div>
      </section>
